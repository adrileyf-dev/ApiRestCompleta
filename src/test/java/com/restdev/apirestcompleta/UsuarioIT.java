...
import com.restdev.apirestcompleta.web.dto.UsuarioCreateDto;
import com.restdev.apirestcompleta.web.dto.UsuarioResponseDto;
import com.restdev.apirestcompleta.web.dto.UsuarioSenhaDto;
...
public class UsuarioIT {
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        UsuarioResponseDto responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/10")
                .headers(JwtAutentication.getHeaderAuthorization(testClient,"patricia@gmail.com","123546"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("patricia@gmail.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getRole()).isEqualTo("ADMIN");

        responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/9")
                .headers(JwtAutentication.getHeaderAuthorization(testClient,"ana@gmail.com","123546"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(9);
